...
<div class="banner">
        ...
        <div class="banner-text rvl-left">
            ...
            <div class="banner-text-content">
                ...
                <?php
                    ...
                    if (!empty($button_name) && !empty($banner_link)) {
                        echo '<a class="learn-more-link" href="' . esc_url($banner_link) . '">' . esc_html($button_name) . ' <img class="arrow-right" src="/wp-content/uploads/2018/10/right0arrow.png"/>123</a>';
                    }
                ?>
    ...
    <?php // }
    ?>
    <!-- <img class="" src="<?php // echo get_field("banner_image"); ?>"/> -->
        ...
        <div class="banner-text rvl-left">
            ...
            <div class="banner-text-content">
                ...
                <?php
                    ...
                    if (!empty($button_name) && !empty($banner_link)) {
                        echo '<a class="learn-more-link" href="' . esc_url($banner_link) . '">' . esc_html($button_name) . ' <img class="arrow-right" src="/wp-content/uploads/2018/10/right0arrow.png"/></a>';
                    }
                ?>
            </div>
        </div>
        ...
        <div class="who-we-are">
            ...
            <?php
				...
				<div class="gen-learn-more" >
                    <?php
                    $wwe_learn_more = get_field("wwe_learn_more");
                    $wwe_learn_more_button_link = get_field("wwe_learn_more_button_link");

                    if (!empty($wwe_learn_more) && !empty($wwe_learn_more_button_link)) {
                        echo '<a class="learn-more-link white-link" href="' . esc_url($wwe_learn_more_button_link) . '">' . esc_html($wwe_learn_more) . ' <img class="arrow-right" src="/wp-content/uploads/2018/10/bluearrow_03.png"/></a>';
                    }
                ?>
				</div>	
            </div>
            <div class="col-md-6 who-we-are-right rvl-right">
                <div class="col-md-10 custom-padding">
                    ...
                    <a class="learn-more-link white-link bottom-right-link" href="<?php echo get_field("wwa_button_link"); ?>"><?php echo get_field("wwa_button_name"); ?> <img class="arrow-right" src="/wp-content/uploads/2018/10/bluearrow_03.png"/></a>
                </div>
            </div>
            <div class="clearfix"></div>
        </div>
